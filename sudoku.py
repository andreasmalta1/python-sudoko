# A GUI sudoku that randomly draws up a new solvable board with every run and that allows user to let the program itself
# solve the puzzle
# To play the game enter a number using your keyboard. Press enter to commit to the number or move on to the next number
# to keep it as a hint.
...
def redraw_window(win, board, timer, strikes):
    ...
    # Draw time
    fnt = pygame.font.SysFont("comicsans", 40)
    text = fnt.render("Time: " + format_time(timer), True, (0, 0, 0))
